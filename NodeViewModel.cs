...
namespace SpreadTrader
{
    public class NodeViewModel : ViewModelBase
    {
        ...
        private void LevelProfitBothGreen(LiveRunner runner1, LiveRunner runner2)
        {
            ...
            Double G5 = runner1.LayValues[0].price;
            Double J5 = runner2.BackValues[0].price;
        ...
        private void LevelProfit(LiveRunner runner1, LiveRunner runner2)
        {
            ...
            runner1.LevelStake = Math.Abs(Math.Round(G3 < 0 ? G10 : G13, 2));
        ...
        public void CalculateLevelProfit()
        {
            if (LiveRunners.Count > 1)
            {
                ...
                {
                    LevelProfit(LiveRunners[0], LiveRunners[1], LiveRunners[2]);
                }
            }
        }
